...
#include <SD.h>                 // added: required when compiling as separate .cpp in PlatformIO
#include <Arduino.h>
...
#define I2S_WS      7          // add-on: L/R pin INMP441 on Vcc is RIGHT channel, connected to GND is LEFT channel
#define I2S_SD      8          
#define I2S_SCK     17     
